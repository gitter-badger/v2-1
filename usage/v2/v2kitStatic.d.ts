...
interface V2kitStatic {
    ...
    */
     ...
     */
    each<T, TArray extends ArrayLike<T>>(array: TArray, callback: (value: T, index: number, array: TArray) => any, context: any): T;
    /**
     * 对象遍历
     ...
     * @param context 回调函数的上下文对象。
     */
    each<T, K extends keyof T>(object: T, callback: (value: T[K], propertyName: K, object: T) => any, context: any): T;
    /**
     * 数组映射。
     * @param array 需要映射的数组。
     * @param callback 回调函数。
